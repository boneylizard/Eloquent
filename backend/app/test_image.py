...
def test():
    # Paths
    model_path = Path("C:/Users/user/OneDrive/Desktop/LLM AI GGUFs/gemma-3-4b-it-Q6_K.gguf")
    mmproj_path = Path("C:/Users/user/OneDrive/Desktop/LLM AI GGUFs/mmproj-F32.gguf")
    test_image = Path("C:/Users/user/Downloads/file_00000000684861f889454b35a506307f.png")
